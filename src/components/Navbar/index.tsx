...
import { LaptopViewNav } from "./laptop-view";
import { NavProvider } from "@/hooks/nav-context";
import { MobileNav } from "./mobile-view";
  ...
  return (
    <nav className="w-full h-[78px] bg-black absolute top-0 z-20 ">
      <ul className="w-full h-full flex items-center ">
        <li>
          ...
          >
            <svg
              width="85"
              height="27"
              className="inline-block ml-[2rem] "
        ...
        <li>
          <a
            href="https://valorant.zing.vn/vi-vn/"
            target="_self"
            rel="noopener noreferrer"
          >
            <svg
              className="ml-[1.5rem] mr-[0.75rem]"
        ...
        <li>
          <div
            className="p-3 transition-all hover:bg-[#808080] 
          hover:bg-opacity-20 rounded-md cursor-pointer "
          >
            <svg
              stroke="currentColor"
              fill="currentColor"
        ...
        <li>
          <a
            ...
            target="_blank"
            className="px-4 py-2 navBreak:inline-block !bg-vRed text-[#111] 
            uppercase relative before:content-[''] 
            before:w-1 before:h-1 before:bg-[#111111] 
            before:absolute before:top-0 before:left-0 
            text-[13px] tracking-[0.08em] leading-[16px] 
            truncate font-[600] text-center 
            transition-all h-[32px] 
            after:content-[''] 
