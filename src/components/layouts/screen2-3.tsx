...
import screen2And3Bg from "../../asset/frame2-3-bg-cut.png";
import { Frame2 } from "../Frame/Frame2";
import { Frame3 } from "../Frame/Frame3";
import ellipse from "../../asset/Ellipse.png";
import screen2And3Mb from "../../asset/mb-screen2-3.png"

export const Screen2And3 = () => {
  return (
    <>
      <div
        className="w-full h-[220vh] absolute z-10 top-[94%] bg-no-repeat
...
"
      ...
      <div
        className="w-full h-[220vh] absolute z-10 top-[93%] bg-no-repeat
