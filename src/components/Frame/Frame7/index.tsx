...
import vng from "../../../asset/vng-logo.png";
import rule from "../../../asset/rule.png";
...
export const Frame7 = () => {
  return (
    ...
    >
      ...
      <div className="w-full h-full  flex gap-0 flex-col ">
          ...
          >
            ...
            >
              <svg
                width="150"
                height="50"
                className="_32ANSIZormifc9Vc6VVwrx"
            ...
            <a href="https://vnggames.com/" target="_blank">
              <Image
                src={vng.src}
                alt="vng-logo"
                className="invert w-[60px]"
                width={109}
                height={76}
              />
            </a>
          </div>
          <h3 className="text-white md:mt-2 lg:mt-2 lg:text-xl font-myriad">
            © 2022 Riot games, Inc
          </h3>
          <div
